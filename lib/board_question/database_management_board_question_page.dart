...
class DatabaseManagementBQ extends StatefulWidget {
  @override
  _DatabaseManagementBQState createState() => _DatabaseManagementBQState();
}

class _DatabaseManagementBQState extends State<DatabaseManagementBQ> {
...
Future<Channel> fetchChannel({String channelId}) async {
  ...
  if (response.statusCode == 200) {
    ...
    channel.videos = await fetchVideosFromPlaylist(
      playlistId: DATABASE_MANAGEMENT_BQ,
    );
    return channel;
  } else {
