...
class NumAndLogicBQ extends StatefulWidget {
  @override
  _NumAndLogicBQState createState() => _NumAndLogicBQState();
}

class _NumAndLogicBQState extends State<NumAndLogicBQ> {
...
Future<Channel> fetchChannel({String channelId}) async {
  ...
  if (response.statusCode == 200) {
    ...
    channel.videos = await fetchVideosFromPlaylist(
      playlistId: NUMBER_AND_LOGIC_GATE_BQ,
    );
    return channel;
  } else {
