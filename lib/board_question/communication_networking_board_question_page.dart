...
class CommunicationNetworkingBQ extends StatefulWidget {
  @override
  _CommunicationNetworkingBQState createState() =>
      _CommunicationNetworkingBQState();
}

class _CommunicationNetworkingBQState extends State<CommunicationNetworkingBQ> {
  ...
  Future<Channel> fetchChannel({String channelId}) async {
    ...
    if (response.statusCode == 200) {
      ...
      channel.videos = await fetchVideosFromPlaylist(
        playlistId: COMMUNICATION_NETWORKING_BQ,
      );
      return channel;
    } else {
