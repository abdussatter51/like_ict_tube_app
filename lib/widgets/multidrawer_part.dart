...
import 'package:like_ict_tube_app/widgets/drawerPart.dart';
import 'package:like_ict_tube_app/widgets/mulitidrawer_body_part.dart';

class MultidrawerPart extends StatefulWidget {
  @override
  _MultidrawerPartState createState() => _MultidrawerPartState();
}
class _MultidrawerPartState extends State<MultidrawerPart> {
  ...
  showExitPopup(){
    return showDialog(
      ...
      builder: (context){
          return AlertDialog(
            title: Text('Confirm Exit!', style: menuStyle,),
            content: Text('Are you sure to exit from Like ICT-Tube app?', style: TextStyle(fontSize: 18, fontStyle: FontStyle.italic, fontFamily: 'Lato'),),
            actions: <Widget>[
              RaisedButton(
