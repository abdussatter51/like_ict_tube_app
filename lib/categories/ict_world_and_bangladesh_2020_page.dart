...
class ICTWorldAndBangladesh2020 extends StatefulWidget {
  @override
  _ICTWorldAndBangladesh2020State createState() => _ICTWorldAndBangladesh2020State();
}

class _ICTWorldAndBangladesh2020State extends State<ICTWorldAndBangladesh2020> {
...
Future<Channel> fetchChannel({String channelId}) async {
  ...
  if (response.statusCode == 200) {
    ...
    channel.videos = await fetchVideosFromPlaylist(
      playlistId: ICT_WORLD_AND_BANGLADESH_2020,
    );
    return channel;
  } else {
