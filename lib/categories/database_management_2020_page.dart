...
class DatabaseManagement2020 extends StatefulWidget {
  @override
  _DatabaseManagement2020State createState() => _DatabaseManagement2020State();
}

class _DatabaseManagement2020State extends State<DatabaseManagement2020> {
...
Future<Channel> fetchChannel({String channelId}) async {
  ...
  if (response.statusCode == 200) {
    ...
    channel.videos = await fetchVideosFromPlaylist(
      playlistId: DATABASE_MANAGEMENT_2020,
    );
    return channel;
  } else {
