...
class CProgram2019 extends StatefulWidget {
  @override
  _CProgram2019State createState() => _CProgram2019State();
}

class _CProgram2019State extends State<CProgram2019> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //categoryAppBar('CHAPTER-5', 'C-Programming'),
      body: _channel != null
