...
class DataCommunication2020 extends StatefulWidget {
  @override
  _DataCommunication2020State createState() => _DataCommunication2020State();
}

class _DataCommunication2020State extends State<DataCommunication2020> {
...
Future<Channel> fetchChannel({String channelId}) async {
  ...
  if (response.statusCode == 200) {
    ...
    channel.videos = await fetchVideosFromPlaylist(
      playlistId: DATA_COMMUNICATIONCR_2020,
    );
    return channel;
  } else {
